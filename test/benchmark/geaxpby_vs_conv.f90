program dot_vs_conv
    ...
    do i = 1, number_of_runs
      ...
      call psb_geaxpby(done,local_vect_1,done, local_vect_2,desc_a, info)
      ...
      do j = 1, size(temp_local_vect_1)
        temp_local_vect_1_lower(j) = real(temp_local_vect_1(j),4)
      end do
      ...
      call psb_geaxpby(sone,local_vect_1_lower, sone, local_vect_2_lower,desc_a, info)
      ...
      do j = 1, size(temp_local_vect_1)
        temp_local_vect_1(j) = temp_local_vect_1_lower(j) * 1.d0
      end do
      ...
      if(my_rank == psb_root_) write(*,*) single_to_double(i), double_to_single(i), single_scalar_product_timer(i),&
      & double_scalar_product_timer(i), j
    end do
    ...
    if(my_rank == psb_root_) then
      ...
      write(12, '("|  S geaxpby         |", es20.5, "|", es20.5, "|")') mean_s_scalar_product, var_s_scalar_product
      write(12, '("|  D geaxpby         |", es20.5, "|", es20.5, "|")') mean_d_scalar_product, var_d_scalar_product
